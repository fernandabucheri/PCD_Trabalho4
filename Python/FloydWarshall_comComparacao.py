...
if __name__ == '__main__':
    ...
    print('Original:\n', generated_graph)
    print('Resultado Paralelo:\n', floyd_parallel_result)
    print('Resultado Serial:\n', floyd_original_result)
    print('Resultado paralelo == resultado serial:',
          np.array_equal(floyd_parallel_result, floyd_original_result))
